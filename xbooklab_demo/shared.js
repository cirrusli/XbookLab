  ...
  if (!window.comments) window.comments = [
    {
      ...
      content: "这本书的内容非常实用，特别是第三章关于架构设计的部分让我受益匪浅。",
      time: "1小时前",
      likes: 12
    },
    {
      ...
      content: "作者的观点很有启发性，但我觉得第五章的案例可以更详细一些。",
      time: "3小时前",
      likes: 8
    },
    {
...
function initComments(containerId) {
  ...
  container.innerHTML = window.comments.map(comment => `
